...
import { useGlobalState } from "../backend";
    ...
    <div className="flex h-screen w-full">
      <div className="h-screen w-screen bg-gray-100 text-gray-900 flex justify-center">
        <div className="max-w-screen-xl m-0 sm:m-10 bg-white shadow sm:rounded-lg flex justify-center flex-1">
          <div className="lg:w-1/2 xl:w-5/12 p-6 sm:p-12 flex flex-col items-center justify-center">
            ...
            <div className="mt-6 items-center">
              <h1 className="text-2xl xl:text-3xl font-bold">
                One step ahead to begin your crowdfunding journey.
              </h1>
          ...
          <div className="flex-1 bg-indigo-100 flex items-center justify-center text-center hidden lg:flex">
            <div className="hidden relative lg:flex h-screen w-1/2 flex items-center justify-center">
              <div className="w-60 h-60 bg-gradient-to-tr from-indigo-600 to-pink-600 rounded-full animate-bounce" />
